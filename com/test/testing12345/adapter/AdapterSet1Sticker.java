...
public class AdapterSet1Sticker extends RecyclerView.Adapter<AdapterSet1Sticker.ViewHolder> {

    Context context;
    ArrayList<Integer> listOfGif;
    OnItemClickListener1 onItemClickListener1;
    public AdapterSet1Sticker(Context customKeyBoard, ArrayList<Integer> gifList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull AdapterSet1Sticker.ViewHolder holder, int position) {
