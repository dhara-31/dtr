...
public class StiAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<Integer> arrayList;
    ImageView imageView_app_icon;

    public StiAdapter(Context context, ArrayList<Integer> userTaskInfos) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(CustonmStickerCkFragment.listSet == i){
            imageView_app_icon.setAlpha(1f);
        }else {imageView_app_icon.setAlpha(0.6f);
