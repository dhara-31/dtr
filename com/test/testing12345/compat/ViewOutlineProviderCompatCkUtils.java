...
public class ViewOutlineProviderCompatCkUtils {
    private ViewOutlineProviderCompatCkUtils() {
     }
    ...
    public static InsetsUpdater setInsetsOutlineProvider(final View view) {
        ...
        return ViewOutlineProviderCompatCkUtilsLXX.setInsetsOutlineProvider(view);
    }
}
