...
package com.test.testing12345.compat;
...
class ViewOutlineProviderCompatCkUtilsLXX {
    private ViewOutlineProviderCompatCkUtilsLXX() {
     }

    static ViewOutlineProviderCompatCkUtils.InsetsUpdater setInsetsOutlineProvider(final View view) {
    ...
    private static class InsetsOutlineProvider extends ViewOutlineProvider
            implements ViewOutlineProviderCompatCkUtils.InsetsUpdater {
