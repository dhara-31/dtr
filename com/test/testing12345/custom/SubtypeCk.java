...
public final class SubtypeCk {
    ...
    private final Resources mResources;
     ...
     public SubtypeCk(final String locale, final String layoutSet, final int layoutNameRes,
     ...
     public SubtypeCk(final String locale, final String layoutSet, final String layoutNameStr,
                      final boolean showLayoutInName, final Resources resources) {
        mLocale = locale;
        mLayoutSet = layoutSet;
     ...
     public Locale getLocaleObject() {
        return LocaleCkUtils.constructLocaleFromString(mLocale);
    }

     public String getName() {
        final String localeDisplayName =
                LocaleResourceCkUtils.getLocaleDisplayNameInSystemLocale(mLocale);
     ...
     public String getLayoutDisplayName() {
        ...
        if (mLayoutNameRes != NO_RESOURCE) {
            ...
            displayName = LocaleResourceCkUtils.getLanguageDisplayNameInSystemLocale(mLocale);
        }
        return displayName;
    }
    ...
    public boolean equals(final Object o) {
        if (!(o instanceof SubtypeCk)) {
            return false;
        }
        final SubtypeCk other = (SubtypeCk)o;
