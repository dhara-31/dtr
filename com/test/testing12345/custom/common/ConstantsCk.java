...
public final class ConstantsCk {
    ...
    public static boolean isNumericKeyboard = false;
    ...
    public static final int CODE_NUMBER = -18;
    public static final int CODE_SYMBOL = -19;
    ...
    public static String printableCode(final int code) {
        ...
        case CODE_SPACE: return "space";
            case CODE_NUMBER: return "alphabet_number";
