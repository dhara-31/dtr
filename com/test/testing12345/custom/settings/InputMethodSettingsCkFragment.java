...
public abstract class InputMethodSettingsCkFragment extends PreferenceFragment {
    private final InputMethodSettingsCkImpl mSettings = new InputMethodSettingsCkImpl();
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        final Context context = getActivity();
        setPreferenceScreen(getPreferenceManager().createPreferenceScreen(
                PreferenceCkManagerCompat.getDeviceContext(context)));
