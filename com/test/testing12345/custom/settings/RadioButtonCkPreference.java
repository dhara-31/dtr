...
public class RadioButtonCkPreference extends Preference {
    interface OnRadioButtonClickedListener {

        void onRadioButtonClicked(RadioButtonCkPreference preference);
    }
    ...
    public RadioButtonCkPreference(final Context context) {
        this(context, null);
    }

    public RadioButtonCkPreference(final Context context, final AttributeSet attrs) {
