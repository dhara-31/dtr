...
import com.test.testing12345.custom.AudioAndHapticFeedbackCkManager;
import com.test.testing12345.custom.InputCkAttributes;
import com.test.testing12345.custom.utils.ResourceCkUtils;

public final class SettingsCk implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = SettingsCk.class.getSimpleName();
    ...
    private static final int UNDEFINED_PREFERENCE_VALUE_INT = 0;
    ...
    private static final SettingsCk sInstance = new SettingsCk();

    public static SettingsCk getInstance() {
        return sInstance;
    }
    ...
    public void onSharedPreferenceChanged(final SharedPreferences prefs, final String key) {
        ...
        try {
            if (mSettingsCkValues == null) {

                return;
            }
            loadSettings(mSettingsCkValues.mInputCkAttributes);
        } finally {
            mSettingsValuesLock.unlock();
        }
    }

    public void loadSettings(final InputCkAttributes inputCkAttributes) {
        mSettingsCkValues = new SettingsCkValues(mPrefs, mRes, inputCkAttributes);
    }


    public SettingsCkValues getCurrent() {
        return mSettingsCkValues;
    }
    ...
    public static boolean readVibrationEnabled(final SharedPreferences prefs,
            final Resources res) {
        final boolean hasVibrator = AudioAndHapticFeedbackCkManager.getInstance().hasVibrator();
    ...
    public static float readDefaultKeypressSoundVolume(final Resources res) {
        return Float.parseFloat(ResourceCkUtils.getDeviceOverrideValue(res,
    ...
    public static int readDefaultKeypressVibrationDuration(final Resources res) {
        return Integer.parseInt(ResourceCkUtils.getDeviceOverrideValue(res,
    ...
    public static int readKeyboardDefaultColor(final Context context) {
        ...
        final int themeId = KeyboardCkTheme.getKeyboardTheme(context).mThemeId;
