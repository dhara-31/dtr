...
public final class SingleLanguageSettingsCkFragment extends PreferenceFragment {
    ...
    public void onCreate(final Bundle icicle) {
        ...
        RichInputMethodCkManager.init(getActivity());
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
     ...
     private void buildContent(final String locale, final Context context) {
        ...
        final String localeName = LocaleResourceCkUtils.getLocaleDisplayNameInSystemLocale(locale);
     ...
     private void buildSubtypePreferences(final String locale, final PreferenceGroup group,
        ...
        final List<SubtypeCk> subtypeCks =
                SubtypeLocaleCkUtils.getSubtypes(locale, context.getResources());
        mSubtypePreferences = new ArrayList<>();
        for (final SubtypeCk subtypeCk : subtypeCks) {
            final boolean isChecked = enabledSubtypeCks.contains(subtypeCk);
            final SubtypePreference pref = createSubtypePreference(subtypeCk, isChecked, context);
    ...
    private SubtypePreference createSubtypePreference(final SubtypeCk subtypeCk,
                                                      final boolean checked,
                                                      final Context context) {
        final SubtypePreference pref = new SubtypePreference(context, subtypeCk);
        pref.setTitle(subtypeCk.getLayoutDisplayName());
     ...
     private static class SubtypePreference extends SwitchPreference {
        final SubtypeCk mSubtypeCk;

         public SubtypePreference(final Context context, final SubtypeCk subtypeCk) {
            super(context);
            mSubtypeCk = subtypeCk;
        }

         public SubtypeCk getSubtype() {
            return mSubtypeCk;
        }
    }
}
