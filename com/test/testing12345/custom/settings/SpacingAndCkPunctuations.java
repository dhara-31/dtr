...
public final class SpacingAndCkPunctuations {
    ...
    public SpacingAndCkPunctuations(final Resources res) {
        mSortedWordSeparators = StringCkUtils.toSortedCodePointArray(
                res.getString(R.string.symbols_word_separators));
        mSortedSentenceTerminators = StringCkUtils.toSortedCodePointArray(
