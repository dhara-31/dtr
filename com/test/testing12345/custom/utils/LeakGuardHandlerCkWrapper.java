...
public class LeakGuardHandlerCkWrapper<T> extends Handler {
    private final WeakReference<T> mOwnerInstanceRef;

    public LeakGuardHandlerCkWrapper(final T ownerInstance) {
        this(ownerInstance, Looper.myLooper());
    }

    public LeakGuardHandlerCkWrapper(final T ownerInstance, final Looper looper) {
        super(looper);
