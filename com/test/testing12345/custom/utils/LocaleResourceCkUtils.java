...
public final class LocaleResourceCkUtils {
    ...
    private static Locale getDisplayLocale(final String localeString) {
        ...
        return LocaleCkUtils.constructLocaleFromString(localeString);
    }
    ...
    public static String getLanguageDisplayNameInSystemLocale(
        ...
        if (sExceptionalLocaleDisplayedInRootLocale.containsKey(localeString)) {
            ...
            languageString = LocaleCkUtils.constructLocaleFromString(localeString).getLanguage();
        }
    ...
    private static String getLocaleDisplayNameInternal(final String localeString,
        ...
        if (exceptionalNameResId != null) {
            ...
            displayName = LocaleCkUtils.constructLocaleFromString(localeString)
                    .getDisplayName(displayLocale);
        }
        return StringCkUtils.capitalizeFirstCodePoint(displayName, displayLocale);
    }
}
