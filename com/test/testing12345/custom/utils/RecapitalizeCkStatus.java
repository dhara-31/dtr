...
public class RecapitalizeCkStatus {
    ...
    private static final int getStringMode(final String string) {
        if (StringCkUtils.isIdenticalAfterUpcase(string)) {
            return CAPS_MODE_ALL_UPPER;
        } else if (StringCkUtils.isIdenticalAfterDowncase(string)) {
            return CAPS_MODE_ALL_LOWER;
        } else if (StringCkUtils.isIdenticalAfterCapitalizeEachWord(string)) {
     ...
     public void rotate() {
        ...
        do {
            ...
            case CAPS_MODE_FIRST_WORD_UPPER:
                mStringAfter = StringCkUtils.capitalizeEachWord(mStringBefore, mLocale);
                break;
