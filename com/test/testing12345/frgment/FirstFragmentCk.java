...
public class FirstFragmentCk extends Fragment {
   public static LanAdapter lanAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frgment_first,
                container, false);
    ...
    private void setLan() {
        ...
        stringArrayList.add("Malayalam");
        stringArrayList.add("Tamil");
        stringArrayList.add("Telugu");
    ...
    private class LanAdapter extends RecyclerView.Adapter<LanAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
         ...
         @Override
        public void onBindViewHolder(@NonNull @NotNull FirstFragmentCk.LanAdapter.ViewHolder holder, int position) {
