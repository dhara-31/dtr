...
public class SecondFragmentCk extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frgment_second
                ,
                container, false);
    ...
    private void setLan() {
        ...
        stringArrayList.add("French");
        stringArrayList.add("German");
        stringArrayList.add("Italian");
        stringArrayList.add("Nepali");
        stringArrayList.add("Russian");
        stringArrayList.add("Thai");
