 ...
 */
public final class KeyboardCkId {
    ...
    public static final int ELEMENT_BIG_NUMBER = 18;

    public final SubtypeCk mSubtypeCk;
    ...
    public KeyboardCkId(final int elementId, final KeyboardLayoutCkSet.Params params) {
        mSubtypeCk = params.mSubtypeCk;
    ...
    private static int computeHashCode(final KeyboardCkId id) {
    ...
    private boolean equals(final KeyboardCkId other) {
        if (other == this)
            return true;
        return other.mElementId == mElementId
                ...
                && other.mSubtypeCk.equals(mSubtypeCk)
    ...
    public boolean passwordInput() {
        ...
        return InputTypeCkUtils.isPasswordInputType(inputType)
    ...
    public int imeAction() {
        return InputTypeCkUtils.getImeOptionsActionIdFromEditorInfo(mEditorInfo);
    }

    public Locale getLocale() {
        return mSubtypeCk.getLocaleObject();
    }

    @Override
    public boolean equals(final Object other) {
        return other instanceof KeyboardCkId && equals((KeyboardCkId) other);
    }
    ...
    public String toString() {
        return String.format(Locale.ROOT, "[%s %s:%s %dx%d %s %s%s%s%s%s%s %s]",
                ...
                mSubtypeCk.getLocale(),
                mSubtypeCk.getKeyboardLayoutSet(),
                mWidth, mHeight,
                modeName(mMode),
                ...
                KeyboardCkTheme.getKeyboardThemeName(mThemeId)
        );
    }
    ...
    public static String elementIdToName(final int elementId) {
        ...
        case ELEMENT_BIG_NUMBER: return "alphabetNumber";
        default: return null;
        }
    }
    ...
    public static String actionName(final int actionId) {
        return (actionId == InputTypeCkUtils.IME_ACTION_CUSTOM_LABEL) ? "actionCustomLabel"
                : EditorInfoCompatCkUtils.imeActionName(actionId);
    }
}
