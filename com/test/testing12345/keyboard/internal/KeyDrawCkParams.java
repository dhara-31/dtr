...
public final class KeyDrawCkParams {
    ...
    public KeyDrawCkParams() {}

    private KeyDrawCkParams(final KeyDrawCkParams copyFrom) {
    ...
    public void updateParams(final int keyHeight, final KeyVisualCkAttributes attr) {
        if (attr == null) {
            return;
        }
    ...
    public KeyDrawCkParams mayCloneAndUpdateParams(final int keyHeight,
                                                   final KeyVisualCkAttributes attr) {
        if (attr == null) {
            return this;
        }
        final KeyDrawCkParams newParams = new KeyDrawCkParams(this);
    ...
    private static int selectTextSizeFromDimensionOrRatio(final int keyHeight,
        ...
        if (ResourceCkUtils.isValidDimensionPixelSize(dimens)) {
            return dimens;
        }
        if (ResourceCkUtils.isValidFraction(ratio)) {
