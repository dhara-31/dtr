...
public class AnimVideoCAAdapter extends RecyclerView.Adapter<AnimVideoCAAdapter.ViewHolder> {
    ...
    public AnimVideoCAAdapter(Context context, ArrayList<CADatum> appList) {
    ...
    public interface OnItemClickListenerS {
        ...
        void onItemClick1(View view, CADatum CADatum, int position);
    }
        ...
        public void bind(int position) {
            ...
            binding.image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onItemClickListenerS.onItemClick1(v, adImageList.get(position), position);
                }
            });
