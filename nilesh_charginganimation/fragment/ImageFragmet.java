...
import com.si_charginganimation.nilesh_charginganimation.adapter.ImageCAAdapter;
...
public class ImageFragmet extends Fragment {
    ...
    private void setData() {
        ...
        if(imageCAAdapter != null){
            ...
            imageCAAdapter = new ImageCAAdapter(getContext(),imageList);
            recyclerView.setAdapter(imageCAAdapter);
        }
    }
