...
public class ClockLiner extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public ClockLiner(Context context) {
        super(context);
        initClock();
    }

    public ClockLiner(Context context, AttributeSet attrs) {
        super(context, attrs);
        initClock();
    }
